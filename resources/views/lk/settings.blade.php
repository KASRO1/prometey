                     ...
                     &quot;stickyOffsetTop&quot;: 20
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#content">
                                    <i class="bi-person nav-icon"></i> Базовая информация
                                </a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-lg-9">
                <div class="d-grid gap-3 gap-lg-5">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <form action="{{route("lk.settings.base.save")}}" method="post">
                                <!-- Form -->
                                @csrf
                                <div class="row mb-4">
                                    <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Полное имя</label>

                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-vertical">
                                            <input type="text" class="form-control" name="firstName" id="firstNameLabel" placeholder="Ваше имя" aria-label="Your first name" value="{{$user['first_name']}}">
                                            <input type="text" class="form-control" name="lastName" id="lastNameLabel" placeholder="Ваша фамилия" aria-label="Your last name" value="{{$user['last_name']}}">
                                        </div>
                                    </div>
                                </div>
                                <!-- End Form -->
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" name="email" disabled id="emailLabel" placeholder="Email" aria-label="Email" value="{{$user['email']}}">
                                    </div>
                                </div>
                                <!-- End Form -->
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="addressLine1Label" class="col-sm-3 col-form-label form-label">Ваш Telegram</label>

                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="tg_user" id="addressLine1Label" placeholder="Ваш username телеграм" aria-label="Your address" value="{{$user['tg_username']}}">
                                    </div>
                                </div>
                    ...
                    <div id="passwordSection" class="card">
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <form action="{{route("lk.settings.password.save")}}" method="post">
                                @csrf
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="currentPasswordLabel" class="col-sm-3 col-form-label form-label">Нынешний пароль</label>

                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" name="old_password" id="currentPasswordLabel" placeholder="Нынешний пароль" aria-label="Enter current password">
                                    </div>
                                </div>
                                <!-- End Form -->
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" name="new_password" id="newPassword" placeholder="Введите новый пароль" aria-label="Enter new password">
                                    </div>
                                </div>
                                <!-- End Form -->
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="confirmNewPasswordLabel" class="col-sm-3 col-form-label form-label">Подтвердите пароль</label>

                                    <div class="col-sm-9">
                                        <div class="mb-3">
                                            <input type="password" class="form-control" name="new_password_confirmation" id="confirmNewPasswordLabel" placeholder="Подтвердите пароль" aria-label="Confirm your new password">
                                        </div>
