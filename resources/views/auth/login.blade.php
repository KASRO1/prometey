    ...
    <div class="container py-5 py-sm-7">
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="card card-lg mb-5">
          <div class="card-body">
            <!-- Form -->
            <form method="post" action="{{route("login.post")}}" class="js-validate needs-validation" novalidate>
                @csrf
              <div class="text-center">
                <div class="mb-5">
                  <h1 class="display-5">Авторизация</h1>
                  <p>Еще нет аккаунта? <a class="link" href="{{route("signup")}}">Создайте его здесь</a></p>
                </div>
              ...
              <!-- Form -->
              <div class="mb-4">
                <label class="form-label" for="signinSrEmail">Ваш email</label>
              ...
              <div class="mb-4">
                <label class="form-label w-100" for="signupSrPassword" tabindex="0">
                  <span class="d-flex justify-content-between align-items-center">
                    <span>Пароль</span>
                    <a class="form-label-link mb-0" href="{{route("reset.password")}}">Забыли пароль?</a>
                  </span>
                </label>
        ...
        <div class="position-relative text-center zi-1">
          <small class="text-cap text-body mb-4">Возникли вопросы? <a class="link" href="#">Напишите нам!</a></small>
